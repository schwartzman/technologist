...
$(document).on('keydown', null, 'right down', function(){
	if ( $('#open.box').parent().next().length ) {
		$('#open.box').parent().next().children('.box').click();		
	} else {
		kbrdClose();
	}
});
...
$(document).on('keydown', null, 'left up', function(){
	if ( $('#open.box').parent().prev().length ) {
		$('#open.box').parent().prev().children('.box').click();		
	} else {
		kbrdClose();
	}
});
